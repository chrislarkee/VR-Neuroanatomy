    ...
    public static List<Q> generateQuestions() {
        ...
        allQuestions.Add(Questions.simple(
            "This structure is superior to the Sylvian fissure.",
             new string[] {"Frontal Lobe.CL", "Frontal Lobe.CR", "Parietal Lobe.CR", "Parietal Lobe.CL"},
        ...
        allQuestions.Add(Questions.region(
            ...
            "Brain Stem.CR", "Superior Colliculi",
        ...
        allQuestions.Add(Questions.region(
            ...
            "Brain Stem.CR", "Inferior Colliculi",
        ...
        allQuestions.Add(Questions.region(
            ...
            "Ventricle", "The cerebral aquaduct",
            new Vector3(0.02703f, 0.90636f, 0.22083f),
            .125f));

        allQuestions.Add(Questions.region(
            "Point to the foramen of Magendi.",
            "Ventricle", "The foramen of Magendi",
        ...
        allQuestions.Add(Questions.region(
            ...
            "Ventricle", "The foramen of Luschka",
        ...
        allQuestions.Add(Questions.region(
            ...
            "Ventricle", "The cerebral aqueduct",
